...
export class CashIssuerCreated extends ethereum.Event {
  get params(): CashIssuerCreated__Params {
    return new CashIssuerCreated__Params(this);
  }
}

export class CashIssuerCreated__Params {
  _event: CashIssuerCreated;

  constructor(event: CashIssuerCreated) {
    this._event = event;
  }
...
export class BondIssuerCreated extends ethereum.Event {
  get params(): BondIssuerCreated__Params {
    return new BondIssuerCreated__Params(this);
  }
}

export class BondIssuerCreated__Params {
  _event: BondIssuerCreated;

  constructor(event: BondIssuerCreated) {
    this._event = event;
  }
...
export class Factory extends ethereum.SmartContract {
  ...
  checkSupportForToken(_currency: Bytes): boolean {
    let result = super.call(
  ...
  try_checkSupportForToken(_currency: Bytes): ethereum.CallResult<boolean> {
    let result = super.tryCall(
      "checkSupportForToken",
      "checkSupportForToken(bytes32):(bool)",
      [ethereum.Value.fromFixedBytes(_currency)],
  ...
  getCurrencyToken(_currency: Bytes): Address {
    let result = super.call(
      "getCurrencyToken",
  ...
  try_getCurrencyToken(_currency: Bytes): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "getCurrencyToken",
      "getCurrencyToken(bytes32):(address)",
      [ethereum.Value.fromFixedBytes(_currency)],
...
export class SetCryptoDataURLCall extends ethereum.Call {
  get inputs(): SetCryptoDataURLCall__Inputs {
    return new SetCryptoDataURLCall__Inputs(this);
  }

  get outputs(): SetCryptoDataURLCall__Outputs {
    return new SetCryptoDataURLCall__Outputs(this);
  }
}

export class SetCryptoDataURLCall__Inputs {
  _call: SetCryptoDataURLCall;

  constructor(call: SetCryptoDataURLCall) {
    this._call = call;
  }
...
export class SetCryptoDataURLCall__Outputs {
  _call: SetCryptoDataURLCall;
...
export class SetOraclesCall extends ethereum.Call {
  get inputs(): SetOraclesCall__Inputs {
    return new SetOraclesCall__Inputs(this);
  }

  get outputs(): SetOraclesCall__Outputs {
    return new SetOraclesCall__Outputs(this);
  }
}

export class SetOraclesCall__Inputs {
  _call: SetOraclesCall;

  constructor(call: SetOraclesCall) {
    this._call = call;
  }
...
export class SetOraclesCall__Outputs {
  _call: SetOraclesCall;
